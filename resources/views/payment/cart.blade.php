                                ...
                                <tr>
                                        ...
                                        <div class="product">
                                            <figure class="product-media">
                                                <a href="{{ url($product->slug) }}">
                                                    <img src="{{ url($image->getImageUrl()) }}" alt="Product image">
                                                </a>
                                            </figure>
                                    ...
                                    <td class="quantity-col">
                                        <div class="cart-product-quantity">
                                            <input type="number" class="form-control" value="{{ $value->quantity }}" name="cart[{{ $key }}][qty]" min="1" max="100" step="1" data-decimals="0" required>
                                        </div>
                                        <input type="hidden" class="form-control" 
                                            value="{{ $value->id }}" name="cart[{{ $key }}][id]">

                                    </td>
                                    <td class="total-col">${{ number_format($value->price * $value->quantity, 2) }}</td>
                                    <td class="remove-col"><a href="{{ url('cart/remove/'.$value->id) }}" class="btn-remove"><i class="icon-close"></i></button></td>
                                </tr>
                                @endif
                                @endforeach
