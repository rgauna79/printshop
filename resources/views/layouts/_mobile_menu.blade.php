<div class="mobile-menu-container">
    <div class="mobile-menu-wrapper">
        ...
        <form action="{{ url('search')}}" method="get" class="mobile-search">
            ...
            <input type="search" class="form-control" name="mobile-search" id="mobile-search" placeholder="Search in..." value="{{ !empty(Request::get('mobile-search')) ? Request::get('mobile-search') : '' }}" required>
