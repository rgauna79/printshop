                            ...
                            <div class="product-gallery">
                                ...
                                <figure class="product-main-image">
                                    @if (!empty($getProductImage) && !empty($getProductImage->getImageUrl()))
                                        <img id="product-zoom" src="{{ $getProductImage->getImageUrl() }}"
                                            data-zoom="{{ $getProductImage->getImageUrl() }}" alt="product image">
                        ...
                        <div class="col-md-6">
                            <div class="product-details">
                                ...
                                <div class="ratings-container">
                                    <div class="ratings">
                                        <div class="ratings-val" style="width: {{ $getProduct->getAverageReview($getProduct->id) * 20 }}%;"></div>
                                    </div>
                ...
                @foreach ($getRelatedProduct as $value)
                    ...
                    <div class="product product-7">
                        <figure class="product-media">
                            @if (!empty($getProductImage) && !empty($getProductImage->getImageUrl()))
                                <a href="{{ url($value->slug) }}">
                                    <img src="{{ $getProductImage->getImageUrl() }}" alt="{{ $value->title }}"
                                        style="height: 280px; width: 100%; object-fit:cover;" class="product-image">
                                </a>
                            @endif
                            ...
                            <div class="product-action-vertical">
                                @if (!empty(Auth::check()))
                                    <a href="javascript:;" data-toggle="modal" id="{{ $value->id }}"
                        ...
                        <div class="product-body">
                            ...
                            <div class="ratings-container">
                                <div class="ratings">
                                    <div class="ratings-val" style="width: {{ $getProduct->getAverageReview($value->id) * 20 }}%;"></div>
                                </div>
                                <span class="ratings-text">( {{ $getProduct->getTotalReviewProduct($value->id) }} Reviews )</span>
                            </div>
                        </div>
                    </div>
                @endforeach
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#size').change(function() {
                var newSize = $(this).find("option:selected").attr('data-price');
