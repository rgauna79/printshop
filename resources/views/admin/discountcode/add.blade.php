                        ...
                        <div class="card-body">
                          ...
                          <div class="form-group">
                            ...
                            <select class="form-control" name="type" required>
                                <option {{ (old('status') == 'Amount') ? 'selected' : '' }} value="Amount">Amount</option>
                                <option {{ (old('status') == 'Percent') ? 'selected' : '' }} value="Percent">Percent</option>
                            </select>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" 
                                class="form-control" 
                                required value="{{ old('percent_amount')}}" 
                          ...
                          <div class="form-group">
                            ...
                            <input type="date" 
                                class="form-control" 
                                required value="{{ old('expire_date')}}" 
                                name="expire_date">
                          </div>
